...
public class SettingsManager extends BaseSettingsManager {
    ...
    // Support
    public static final String keyPrefChangelog = "pref_changelog";
    public static final String keyPrefFaq = "pref_faq";
    public static final String keyPrefHelp = "pref_help";
    public static final String keyPrefRate = "pref_rate";
    public static final String keyPrefRestorePurchases = "pref_restore_purchases";

    // Display
    public static final String keyPrefTabChooser = "pref_tab_chooser";
    public static final String keyPrefTabDefaultPage = "pref_default_page";
    ...
    // Scrobbler
    public static final String KEY_PREF_DOWNLOAD_SCROBBLER = "pref_download_simple_lastfm_scrobbler";

    // Blacklist/whitelist
    public static final String KEY_PREF_BLACKLIST = "pref_blacklist_view";
    public static final String KEY_PREF_WHITELIST = "pref_whitelist_view";

    // Playback
    public static final String KEY_PREF_REMEMBER_SHUFFLE = "pref_remember_shuffle";

    // Upgrade
    public static final String KEY_PREF_UPGRADE = "pref_upgrade";
